...
while (right_stack.get_size() != num_disks):
  ...
  while True:
    ...
    if from_stack.get_size() == 0:
      ...
      print("\n\nInvalid Move. Try Again")
print("\n\nYou completed the game in {moves}, and the optimal numbers of moves is {optimal}.".format(moves = num_user_moves, optimal = num_optimal_moves))